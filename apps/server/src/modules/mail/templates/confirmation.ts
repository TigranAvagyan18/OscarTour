export const confirmationEmailTemplate = (confirmationLink: string): string => {
	return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 24px rgba(232, 40, 140, 0.08); overflow: hidden;">
                    <tr>
                        <td style="background: linear-gradient(135deg, #E8288C 0%, #D61F7D 100%); padding: 48px 40px; text-align: center;">
                            ...
                            <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 700; letter-spacing: -0.5px;">Confirm Your Email</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 48px 40px;">
                            ...
                            <p style="margin: 0 0 32px; color: #666666; font-size: 16px; line-height: 1.6;">
                                Thank you for signing up with FlowerFinder! We're excited to have you on board. To get started, please confirm your email address by clicking the button below.
                            </p>
                            
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="text-align: center; padding: 0 0 32px;">
                                        <a href="${confirmationLink}" style="display: inline-block; background: linear-gradient(135deg, #E8288C 0%, #D61F7D 100%); color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; padding: 16px 48px; border-radius: 12px; box-shadow: 0 4px 16px rgba(232, 40, 140, 0.25); transition: all 0.3s ease;">
                            ...
                            <p style="margin: 0 0 16px; color: #999999; font-size: 14px; line-height: 1.6;">
                                This confirmation link will expire in 24 hours for security reasons.
                            </p>
                            <p style="margin: 0; color: #999999; font-size: 14px; line-height: 1.6;">
                                If you didn't create an account with FlowerFinder, you can safely ignore this email.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="text-align: center; padding: 0 20px;">
                            <p style="margin: 0; color: #999999; font-size: 12px; line-height: 1.5;">
                                This email was sent to you because you created an account on FlowerFinder.
                            </p>
                        </td>
                    </tr>
                </table>
